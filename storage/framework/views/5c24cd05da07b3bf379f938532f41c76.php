                        ...
                        <form action="<?php echo e(route('produtos.update', $produto->id)); ?>" method="POST">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="categoria" value="<?php echo e($produto->categoria); ?>" class="form-control mb-2">
                                    <input type="number" name="estoque" value="<?php echo e($produto->estoque); ?>" class="form-control mb-2" required>
                                </div>
...
<?php /**PATH C:\Users\marco\projetoDePHP\projetoPHP\resources\views/produto.blade.php ENDPATH**/ ?>